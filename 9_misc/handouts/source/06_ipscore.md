...
> assembling the tool — is a second block, deferred to `05_ipscore_part2.md`. You leave this block
...
| Second block | `2_evidence_from_patstat` · `3_valuation_and_scenarios` · `4_assemble_tool` — see `05_ipscore_part2.md` |
...
> (`05_ipscore_part2.md`) for PATLIBs that want to run it themselves. Nothing in this block is
...
| **`05_ipscore_part2.md`** | The implementation: measuring answers against PATSTAT, sensitivity, and building the report. |

---

## Notes for the next revision

- **`5_ipscore/README.md` is stale.** It states that notebook 2 "does not exist yet" and
