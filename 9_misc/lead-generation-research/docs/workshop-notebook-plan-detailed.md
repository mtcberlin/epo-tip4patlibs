...
`3_lead_generation/docs/workshop-notebook-implementation-plan.md`.

## Context
`epo-tip4patlibs` is EPO Academy training material for PATLIB staff. On `origin/develop`,
the user has started a new module `3_lead_generation/` for **regional lead generation**:
...
## Critical files
- `3_lead_generation/regional-applicant-profiling-instruction.md`
- `3_lead_generation/1_regional-leads.ipynb`
- Reference (read-only): `3_lead_generation/docs/*.md`, `1_startwithtip/2_getting-started-with-patstat.ipynb`
...
### Files
- `3_lead_generation/1_regional-leads.ipynb` (targeted JSON edits)
- `README.md`
