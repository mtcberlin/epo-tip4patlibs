...
*Record of how the `3_lead_generation` workshop notebook and its instruction brief were
...
`3_lead_generation/` teaches **regional lead generation**: profiling the company patent
