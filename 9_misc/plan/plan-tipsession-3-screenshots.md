...
> `1_querylib/TIP_for_PATLIBs_QueryLib.ipynb`
...
> `3_lead_generation/1_regional-leads.ipynb` · **Step 6**
...
5_ipscore_rebuild/4_assemble_tool.ipynb              # re-run, cell 19 cleared
5_ipscore_rebuild/4_tool/ipscore_valuation.html      # new footer
5_ipscore_rebuild/4_tool/ipscore_valuation_data.xlsx
```
