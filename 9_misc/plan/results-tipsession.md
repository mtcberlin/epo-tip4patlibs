...
The O1, O2 and V5 answers are also written into `5_ipscore_rebuild/REBUILD_PLAN.md` under
...
Run from `5_ipscore_rebuild/` on TIP:
...
GET …/5_ipscore_rebuild/4_tool/ipscore_valuation.html → HTTP 200, 4,928,944 bytes, valid HTML
```
...
`/user/…/files/epo-tip4patlibs/5_ipscore_rebuild/4_tool/ipscore_valuation.html?download=1`.
...
| File | Change |
|---|---|
| `5_ipscore_rebuild/REBUILD_PLAN.md` | O1, O2, V5 answered under *Open questions*; V5 section added |
| `9_misc/plan/archive/plan-tipsession-1-recon.md` | Ticked off, pointing here |
| `9_misc/plan/results-tipsession.md` | This file |
