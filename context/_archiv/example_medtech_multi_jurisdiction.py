...
class ExtendedMedicalPatentAnalyzer:
    ...
    MEDICAL_IPC_CLASSES = {
        ...
        'A61K40': 'Medicinal Preparations (Drug Delivery)',
    ...
    def _get_ipc_class_case_statement(self):
        ...
        return case(
            ...
            (and_(TLS209_APPLN_IPC.ipc_class_symbol.like('A61K%40%'), TLS209_APPLN_IPC.ipc_class_level == 'A'), 'A61K40'),
    ...
    def query_applications_by_year_and_class(self, start_year: int = 2013, end_year: int = 2023,
                                            jurisdictions: Union[str, List[str]] = ['EP']) -> pd.DataFrame:
        """
        Query: Applications by year and IPC class with jurisdiction support

        Args:
            start_year: Start year for analysis (default: 2013)
    ...
    def query_top_applicants_by_class(self, top_n: int = 10, start_year: int = 2013, end_year: int = 2023,
                                     jurisdictions: Union[str, List[str]] = ['EP']) -> pd.DataFrame:
        """
    ...
    def query_top_overall_applicants(self, top_n: int = 50, min_applications: int = 10,
                                    start_year: int = 2013, end_year: int = 2023,
                                    jurisdictions: Union[str, List[str]] = ['EP']) -> pd.DataFrame:
        """
    ...
    def compare_jurisdictions(self, jurisdictions: List[str] = ['EP', 'DE', 'US', 'CN'],
                             start_year: int = 2013, end_year: int = 2023) -> Dict[str, pd.DataFrame]:
        """
    ...
    def export_all_analyses(self, output_dir: str = "./charts_data",
                           ...
                           start_year: int = 2013, end_year: int = 2023) -> Dict[str, str]:
        """
...
def run_ep_vs_all_comparison(start_year: int = 2013, end_year: int = 2023,
...
def run_major_jurisdictions_comparison(start_year: int = 2013, end_year: int = 2023,
