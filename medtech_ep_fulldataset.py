...
Features:
- EP patent applications (2012-2023)
...
class BVMedExporter:
    ...
    def __init__(self):
        ...
        self.medical_cpc_classes = [
            ...
            'A61H%', 'A61J%', 'A61K__40%', 'A61L%', 'A61M%', 'A61N%'
        ]
    ...
    def build_query(self, start_year=2013, end_year=2023, jurisdiction='EP'):
        """
    ...
    def export_csv(self, output_path=None, start_year=2012, end_year=2023, jurisdiction='EP'):
        """
...
def main():
    ...
    print("📊 EP Applications 2012-2023")
    print("=" * 60)
