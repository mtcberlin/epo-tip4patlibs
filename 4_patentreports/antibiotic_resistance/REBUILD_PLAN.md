...
1. **The current module `4_patentreports/1_antibiotic_resistance/` — the primary reference.** Its
...
0. **Step 0 — scaffold.** Create `4_patentreports/2_antibiotic_resistance_rebuild/` and move this
