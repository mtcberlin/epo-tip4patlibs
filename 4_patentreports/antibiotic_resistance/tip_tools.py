"""Shared helper for the TIP4PATLIBS course notebooks — open an HTML artifact
inside EPO TIP so that it actually works.
...
are byte-identical on purpose.
  ...
  4_patentreports/antibiotic_resistance/tip_tools.py
  5_ipscore/tip_tools.py
